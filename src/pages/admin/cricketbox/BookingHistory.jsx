...
export default BookingHistory
                <aside className="booking-history-sidebar {mobileMenuOpen ? "mobile-open" : ""}">
                    <div className="booking-history-brand">
                        <div className="booking-history-brand-icon">🏠</div>
                        <div><strong>Hostel</strong><span>Admin Panel</span></div>
                    </div>
                    <nav className="booking-history-nav">
                    ...
                    <button className="booking-history-logout" onClick={handleLogout}>🚪 Logout</button>
                </aside>
                {mobileMenuOpen && (
